...
class TemplateService:
    ...
    def get_schema_path( self, template_id: str) -> Path:
    ...
    def load_schema(self, template_id: str) -> TemplateSchema:

        schema_path = self.get_schema_path(template_id)
    ...
    def list_templates(self):
        ...
        for schema_file in self.templates_dir.glob("*.schema.json"):
                ...
                templates.append(
                    {
                        ...
                        "docx_exists": self.get_template_path(template_id).exists()
                    }
                )

            except Exception as e: templates.append(
                    {
